...
# Need to check if ImageMagick/ffmpeg or similar is available for conversion
# But given this is just python, we can use PIL (pillow) and pillow-heif for HEIC if available.
# Let's write a script that tries to handle HEIC locally using python.
...
with open(r"C:\Users\Zonia\Desktop\JB Woodworks\convert_media.py", "w", encoding="utf-8") as f:
    f.write(script)
